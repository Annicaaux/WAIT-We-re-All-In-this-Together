...
def get_group_card_class(category):
    ...
    classes = {
        ...
        "computer_science": "group-card-bio",
        "other": "group-card-new",
        "new": "group-card-new"
    }
...
def render_group_card(group):
    """Render a group card with styling"""
...
def render_reward_system():
    """Render the stamp reward system"""
...
def render_countdown_timer():
    """Render 2-minute countdown timer"""
        ...
        if st.session_state.countdown_time > 0:
            ...
            with col2:
                if st.button("⬇️ -10 Sek", use_container_width=True):
                    ...
                    st.rerun()
            with col3:
                if st.button("⏭️ Fertig", use_container_width=True):
    ...
    return {
        "solo": [
            ...
            },
            {
                ...
                "instructions": "Fahre zum Holstentor, setze dich auf eine Bank und genieße das UNESCO-Welterbe.",
                "stamps": 1
            }
        ],
        "gruppe": [
            ...
            },
            {
                ...
                "instructions": "Startet am Holstentor und erkundet die Gänge und Höfe der Altstadt zusammen.",
                "stamps": 2
            }
        ]
    }
    ...
    with tab2:
        ...
        with st.form("create_group_form"):
            ...
            with col1:
                ...
                room = st.selectbox("📍 Treffpunkt in Lübeck", get_luebeck_locations())
